          ...
          <B.Navbar.Collapse id="basic-navbar-nav">
            ...
            <B.Nav className="me-auto">
              ...
              <B.NavDropdown title="Основы">
                <B.NavDropdown.Item href="/lessons/basics/1">1. Введение в HTML</B.NavDropdown.Item>
                <B.NavDropdown.Item href="/lessons/basics/2">2. Введение в CSS</B.NavDropdown.Item>
              </B.NavDropdown>
              <B.Nav.Link href="/codewars">Codewars</B.Nav.Link>
              <B.NavDropdown title="Wordle">
                <B.NavDropdown.Item href="/lessons/wordle/1">1. Первый урок</B.NavDropdown.Item>
              </B.NavDropdown>
